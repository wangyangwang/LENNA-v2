class PatternGraphics extends Graphics {
  ...
  void makeDecisions() {
    ...
    print("Number of shapes\033[1;34m"+number+"\033[0m");
    ...
    print("Row/Column number: \033[1;34m" + rowNumber+"\033[0m["+colNumber +"\033[0m");
    ...
    print("Each shape will have\033[1;34m"+vectorNumber+"\033[0m vectices");
    ...
    print("Width of single shape\033[1;34m"+xSize+"\033[0m height\033[1;34m"+ySize+"\033[0m");
    ...
    print("Horizontal gap\033[1;34m"+xgap+"\033[0m" + "vertical gap\033[1;34m"+ygap+"\033[0m");
    ...
    print("Shape rotates 1by1 by ["+degrees(localRotationChange)+"\033[0m");
  ...
  void design() {
    ...
    print("Drawing the pattern on our poster...");
